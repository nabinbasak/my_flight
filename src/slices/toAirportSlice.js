...
const toAirportSlice = createSlice({
  name: 'toAirports',
  initialState,
  reducers: {
...
export const { fetchAirportsStart, fetchAirportsSuccess, fetchAirportsFailure } = toAirportSlice.actions;
...
export default toAirportSlice.reducer;
